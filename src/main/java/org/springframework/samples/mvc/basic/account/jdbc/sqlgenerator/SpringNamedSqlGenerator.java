package org.springframework.samples.mvc.basic.account.jdbc.sqlgenerator;

import java.util.ArrayList;
import java.util.List;

import org.apache.commons.lang.StringUtils;
import org.springframework.samples.mvc.basic.account.jdbc.sqlgenerator.metadata.Column;
import org.springframework.samples.mvc.basic.account.jdbc.sqlgenerator.metadata.Table;
...
public class SpringNamedSqlGenerator implements SqlGenerator {
	...
	private void checkIsSinglePrimaryKey() {
		if (getPrimaryKeyColumns().size() != 1) {
			throw new IllegalStateException("expected single primary key on table:" + getTableName()
