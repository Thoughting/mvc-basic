package org.springframework.samples.mvc.basic.account.jdbc.sqlgenerator.metadata;
...
public class Column {
	...
	public Column(String sqlName, String propertyName, boolean isPrimaryKey, boolean updatable, boolean insertable,
			boolean unique) {
		this.sqlName = sqlName;
		this.propertyName = propertyName;
		this.isPrimaryKey = isPrimaryKey;
